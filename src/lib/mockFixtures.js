...
export const mockFixtures = {
  default: [
    { ...base, id: 'mock-1', stage_name: 'Northbound Static', real_name: 'Avery Lane', email: 'avery@example.test', song_1_title: 'County Line', song_2_title: 'Slow Signal', social_links: { instagram: 'https://instagram.com/example' }, performer_notes: 'Songs about long roads, found family, and learning when to leave the porch light on.', queue_position: 1, current: true, attended: false, auth_user_id: 'mock-performer-1', started_at: '2026-08-09T23:00:00.000Z', completed_at: null },
